...
export default function Order() {
    ...
    function changePage(pageItemObj: any) {
        ...
        <div className='orders-wrapper'>
            <p><Link to="/admin" className='dashboard'>Dashboard</Link> / Orders</p>
                ...
                <tbody>
                    {isLoading ? <div className="d-flex justify-content-center loading-wrapper">
                        ...
                        <tr key={Math.random() * Date.now()} className='order'>
                            ...
                            <td className='date'>{dateFormat((order as Order).createAt.toLocaleString(), "dddd, mmmm dS, yyyy, h:MM:ss TT")}</td>
                            <td>
